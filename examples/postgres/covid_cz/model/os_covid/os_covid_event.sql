...
from (select id, datum, 'I' as covid_event_type, vek::integer, pohlavi, okres_lau_kod
      from stg_covid.stg_mista_covid_nakazeni
      UNION
      select id, datum, 'R' as covid_event_type, vek::integer, pohlavi, okres_lau_kod as covid_event_cnt
      from stg_covid.stg_mista_covid_vyleceni
      UNION
      select id, datum, 'D' as covid_event_type, vek::integer, pohlavi, okres_lau_kod
      from stg_covid.stg_mista_covid_umrti) a