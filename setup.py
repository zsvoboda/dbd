...
REQUIRES = ["jinja2==3.0.3", "sqlalchemy==1.4.25", "sqlparse==0.4.2", "sql-metadata==2.3.0", "networkx==2.6.3",
            ...
            "openpyxl==3.0.9", "pyarrow==6.0.0", "requests==2.27.1", "fsspec==2022.1.0", "s3fs==2022.1.0",
            "psycopg2-binary==2.9.3", "PyMySQL==1.0.2", "greenlet==1.1.2",
            "snowflake-connector-python==2.7.2", "snowflake-sqlalchemy==1.3.3",
            "sqlalchemy-redshift==0.8.9",
            "google-cloud-storage==2.0.0", "pandas-gbq==0.16.0", "sqlalchemy-bigquery==1.3.0",
